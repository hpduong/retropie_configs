...
def artPath():
    path = xbmc.translatePath('special://home/addons/plugin.video.rsiptv_tv/')
    return path
...
def metaFile():
    path = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.rsiptv_tv/meta')
    return path
