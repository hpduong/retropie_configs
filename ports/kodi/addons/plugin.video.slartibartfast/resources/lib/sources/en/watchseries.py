...
def HostChcker():
    if url_ok("https://watchseries.unblocked.lol"):
        useurl = 'https://watchseries.unblocked.lol'
        
    elif url_ok("http://watchseries.unblocker.cc"):
        useurl = 'http://watchseries.unblocker.cc'
        
    elif url_ok("https://watchseries.unblocked.mx"):
        useurl = 'https://watchseries.unblocked.mx'
...
class source:
    def __init__(self):
        ...
        self.search_link = self.base_link+'/show/search-shows-json'
